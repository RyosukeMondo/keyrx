...
describe('EventLogList', () => {
  ...
  describe('rendering', () => {
    ...
    it('renders table header with column names', () => {
      ...
      expect(screen.getByRole('columnheader', { name: 'Map Type' })).toBeInTheDocument();
  ...
  describe('event data display', () => {
    ...
    it('displays event types with symbols', () => {
      ...
      expect(screen.getByRole('cell', { name: /Event type: press/ })).toBeInTheDocument();
      expect(screen.getByRole('cell', { name: /Event type: release/ })).toBeInTheDocument();
      expect(screen.getByRole('cell', { name: /Event type: tap/ })).toBeInTheDocument();
    });
    ...
    it('displays input key codes with formatting', () => {
      ...
      expect(screen.getByRole('cell', { name: 'Input: B' })).toBeInTheDocument();
    });
    ...
    it('displays output key codes with formatting', () => {
      ...
      expect(screen.getByRole('cell', { name: 'Output: C' })).toBeInTheDocument();
    });

    it('displays latency with correct formatting', () => {
      render(<EventLogList events={mockEvents} />);

      expect(screen.getByRole('cell', { name: 'Latency: 0.50ms' })).toBeInTheDocument();
      expect(screen.getByRole('cell', { name: 'Latency: 0.30ms' })).toBeInTheDocument();
      expect(screen.getByRole('cell', { name: 'Latency: 1.20ms' })).toBeInTheDocument();
    });

    it('displays device names', () => {
      render(<EventLogList events={mockEvents} />);

      const testKeyboardCells = screen.getAllByRole('cell', { name: 'Device: Test Keyboard' });
      expect(testKeyboardCells.length).toBeGreaterThan(0);
      // "Another Keyboard" gets truncated to "Another Keyb…" (12 chars + ellipsis)
      expect(screen.getByRole('cell', { name: 'Device: Another Keyb…' })).toBeInTheDocument();
    });
    ...
    it('truncates long device names', () => {
      ...
      expect(screen.getByRole('cell', { name: 'Device: Very Long De…' })).toBeInTheDocument();
    });

    it('displays mapping type when present', () => {
      render(<EventLogList events={mockEvents} />);

      expect(screen.getByRole('cell', { name: 'Mapping type: tap_hold' })).toBeInTheDocument();
    });
  });
  ...
  describe('mapping detection', () => {
    it('shows mapping triggered indicator for remapped keys', () => {
      ...
      expect(screen.getByRole('cell', { name: 'Mapping triggered' })).toBeInTheDocument();
    });
    ...
    it('shows no mapping indicator for passthrough keys', () => {
      ...
      expect(screen.getByRole('cell', { name: 'No mapping' })).toBeInTheDocument();
    });
    ...
    it('shows mapping triggered for special event types', () => {
      ...
      const triggeredCells = screen.getAllByRole('cell', { name: 'Mapping triggered' });
  ...
  describe('empty states', () => {
    ...
    it('handles events with missing optional fields', () => {
      ...
      expect(screen.getByRole('cell', { name: 'Input: A' })).toBeInTheDocument();
  ...
  describe('key code formatting', () => {
    it('removes KEY_ prefix from key codes', () => {
      ...
      expect(screen.getByRole('cell', { name: 'Input: ENTER' })).toBeInTheDocument();
    });
    ...
    it('removes VK_ prefix from Windows key codes', () => {
      ...
      expect(screen.getByRole('cell', { name: 'Input: ESCAPE' })).toBeInTheDocument();
    });
  ...
  describe('event type styling', () => {
    ...
    it('applies correct styling for hold events', () => {
      ...
      expect(screen.getByRole('cell', { name: /Event type: hold/ })).toBeInTheDocument();
    });
    ...
    it('applies correct styling for macro events', () => {
      ...
      expect(screen.getByRole('cell', { name: /Event type: macro/ })).toBeInTheDocument();
    });
    ...
    it('applies correct styling for layer_switch events', () => {
      ...
      expect(screen.getByRole('cell', { name: /Event type: layer_switch/ })).toBeInTheDocument();
    });
  });
  ...
  describe('latency highlighting', () => {
    it('highlights high latency values', () => {
      ...
      expect(screen.getByRole('cell', { name: 'Latency: 5.00ms' })).toBeInTheDocument();
    });
  ...
  describe('accessibility', () => {
    ...
    it('has descriptive aria-labels on cells', () => {
      ...
      expect(screen.getAllByRole('cell', { name: /Time:/ }).length).toBeGreaterThan(0);
      expect(screen.getAllByRole('cell', { name: /Event type:/ }).length).toBeGreaterThan(0);
      expect(screen.getAllByRole('cell', { name: /Input:/ }).length).toBeGreaterThan(0);
      expect(screen.getAllByRole('cell', { name: /Latency:/ }).length).toBeGreaterThan(0);
    });
  });
});
