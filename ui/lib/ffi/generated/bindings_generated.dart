...
typedef RuntimeAddSlotNative = Pointer<Char> Function(Pointer<Char>, Pointer<Char>);
...
class KeyrxBindingsGenerated {
  ...
  late final FreeEventPayload freeEventPayload = _lookup<NativeFunction<FreeEventPayloadNative>>('keyrx_free_event_payload').asFunction();
