...
- [x] 1. Add `syn` dependency to Cargo.toml
...
- [x] 2. Create ParsedFunction data structures
...
- [x] 3. Implement Rust AST parser using syn
  - File: `core/tests/contract_adherence/parser.rs`
...
- [x] 4. Add unit tests for AST parser
...
- [x] 6. Implement type validation logic
  - File: `core/tests/contract_adherence/type_mapper.rs`
...
- [x] 7. Add unit tests for type mapper
...
- [x] 8. Create ValidationError enum
...
- [x] 9. Implement signature validator
  - File: `core/tests/contract_adherence/validator.rs`
