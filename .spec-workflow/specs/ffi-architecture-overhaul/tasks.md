...
- [x] 10. Migrate Discovery callbacks to EventRegistry
  - File: `core/src/ffi/domains/discovery.rs`
...
- [x] 17. Update KeyrxBridge to use generated bindings
