...
- [ ] 1. Implement BUG #37 hot-unplug regression test
...
- [ ] 2. Calculate actual source hash in compiler
...
- [ ] 3. Handle signal test stubs (defer with documentation)
...
- [ ] 4. Document CheckBytes as feature candidate
